...
* <<Complete Cloud Insight connection prerequisite tasks>>
...
* link:../get-started/install-ads.html[Install the Astra Data Store Monitoring Operator] that is part of the Astra Data Store preview installation instructions.
