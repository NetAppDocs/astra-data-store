...
* link:install-ads.html[Install the Astra Data Store Monitoring Operator] that is part of the Astra Data Store preview installation instructions.
* link:install-ads.html[Install the kubectl-astrads binary] that is part of the Astra Data Store preview installation instructions.
