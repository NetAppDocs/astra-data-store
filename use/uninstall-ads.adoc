...
Before deleting the cluster, manually delete the Astra Data Store volumes, volume snapshots, and export policy.
...
Ensure that the namespace is not stuck in a `Terminating` state:
