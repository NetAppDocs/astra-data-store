...
To uninstall Astra Data Store preview, you will remove workloads, bindings, volumes, export policies, clusters, license, deployment environment, and the Astra Data Store preview namespace.
...
* <<NEW  Uninstall Trident and cluster workloads that use Astra Data Store preview as a storage backend>>
* <<NEW Uninstall Astra Data Store cluster>>
...
. Locate the `uninstall.sh` in the tar file.
. Run this script indicating what you want to uninstall:
+
----
ls
netapp_operator.yaml uninstall.sh
