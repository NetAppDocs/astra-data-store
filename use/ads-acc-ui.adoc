...
*	link:../get-started/setup_overview.html#add-cluster[Add the underlying Kubernetes cluster where Astra Data Store is installed^].
*	link:../get-started/setup_overview.html#add-a-storage-backend[Add an Astra Data Store preview storage backend for that cluster].
+
