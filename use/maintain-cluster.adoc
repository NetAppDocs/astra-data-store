...
.Steps
.	If the new node’s data IP is not already part of the astradscluster CR, do the following:
...
* link:../use/kubectl-commands-ads.html[Manage Astra Data Store preview with kubectl commands]
