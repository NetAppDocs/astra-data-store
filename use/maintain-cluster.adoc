...
.. Edit the astradscluster CR and add the additional dataIP in the ADS Data Networks Addresses field. Replace the information in capital letters with the appropriate values for your environment:
+
[source,sh]
----
