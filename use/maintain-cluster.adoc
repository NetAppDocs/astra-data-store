...
+
----
~% ubectl astrads maintenance update maint1 --node-name="nhcitjj1525" --variant=None
----
...
+
----
~% ubectl edit astradscluster <cluster-name> -n astrads-system
...
* link:../use/kubectl-commands-ads.html[Manage Astra Data Store with kubectl commands].
