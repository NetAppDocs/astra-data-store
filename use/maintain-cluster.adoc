...
+
The `replace` command will execute drive replacement with the passed serial and will wait to return until a replacement is complete or has failed if --wait is passed
+
----
