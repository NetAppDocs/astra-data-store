...
+
Cloud Insights displays information about resources in Astra Data Store preview.
...
* *kubectl commands*: To work with Astra Data Store preview , you can also use kubectl commands directly.
