...
The Astra family of products includes:
...
=== Astra Control deployment models
...
To install and use Astra Control Center, you'll need to meet certain link:../get-started/requirements.html[requirements].

At a high level, Astra Control Center works like this:

* You install Astra Control Center in your local environment. Learn more about how to link:../get-started/install_acc.html[install Astra Control Center].
