...
After you verify that your environment meets general link:../get-started/requirements.html[Astra Data Store requirements], you should verify that your environment also meets minimum requirements for VMware components such as the VMware VASA provider and the NetApp Astra Plugin for VMware vCenter.
...
== Astra Plugin for VMware vCenter requirements
The Astra Plugin for VMware vCenter has the following requirements:
...
The Astra Plugin for VMware vCenter supports the latest versions of the following web browsers:
