...
summary: You can protect Astra Data Store by making snapshots of its VM from your VMware vCenter environment.
---
...
From your VMware vCenter environment, you can protect Astra Data Store by making snapshots of its VM.
