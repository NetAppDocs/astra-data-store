...
Yes. Astra Data Store preview requires NetApp CSI driver Astra Trident version 21.10.1 and above to be deployed on workload Kubernetes clusters. See link:../get-started/requirements.html[Astra Data Store requirements].
...
Astra Data Store preview works with Kubernetes distributions that are compatible with v1.20 and above. However, it is not currently validated with all Kubernetes distributions. See link:../get-started/requirements.html[Astra Data Store preview requirements].
...
See link:../get-started/requirements.html[Astra Data Store preview requirements].
