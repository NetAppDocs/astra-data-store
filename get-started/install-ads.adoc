...
=== With Kubernetes-native commands
// Start snippet: collapsible block (open on page load)
.Details
[%collapsible]
====
To install Astra Data Store using Kubernetes-native commands, complete the installation steps described in <<Install Astra Data Store,this procedure>>.
====
// End snippet
