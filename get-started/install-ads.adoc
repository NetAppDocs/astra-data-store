...
The following procedures are needed only for deployment on the Red Hat OpenShift Container Platform (OCP). These procedures can be skipped for deployment on non-OCP Kubernetes clusters.
