...
* *Standalone*: To install a standalone Astra Data Store, complete the installation steps described in this procedure.

* *Using Astra Control Center*: If you want to use Astra Data Store with Astra Control Center, you can https://docs.netapp.com/us-en/astra-control-center/get-started/setup_overview.html#add-cluster[first add the underlying Kubernetes cluster running Astra Data Store^] and then https://docs.netapp.com/us-en/astra-control-center/get-started/setup_overview.html#add-a-storage-backend[add Astra Data Store as a storage backend to Astra Control Center^].
...
Complete the Astra Data Store standalone deployment on a standard Kubernetes cluster by performing additional link:setup-ads.html[setup tasks].

If you have used Astra Control Center to deploy Astra Data Store, you do not need to follow these link:setup-ads.html[setup tasks] unless you want to configure any additional monitoring options. After you deploy Astra Data Store, you can use Astra Control Center UI to accomplish these tasks:
