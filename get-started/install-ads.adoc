...
summary: You can install a standalone Astra Data Store for use in a standard Kubernetes environment, deploy it using Astra Control Center to use Astra Data Store with VMware or manage it using Astra Control, or install Astra Data Store for use in another supported Kubernetes distribution.
---
...
You can install a standalone Astra Data Store for use in a standard Kubernetes environment, deploy it using Astra Control Center to use Astra Data Store with VMware or manage it using Astra Control, or install Astra Data Store for use in another supported Kubernetes distribution.
...
[%collapsible]
====
To install a standalone Astra Data Store, complete the installation steps described in <<Install Astra Data Store,this procedure>>.
====
// End snippet
...
[%collapsible]
====
To install Astra Data Store with Red Hat OpenShift Container Platform (OCP) environments, complete the installation steps described in <<Install Astra Data Store,this procedure>>. Additional installation steps for Red Hat OpenShift Container Platform (OCP) environments are also described.
====
// End snippet
...
[%collapsible]
====
To install Astra Data Store with Rancher environments, complete the installation steps described in <<Install Astra Data Store,this procedure>>, substituting Rancher commands for kubectl commands.
====
// End snippet
...
[%collapsible]
====
To install Astra Data Store with Anthos, complete the installation steps described in <<Install Astra Data Store,this procedure>> and add the Astra Data Store cluster to your Anthos environment.
