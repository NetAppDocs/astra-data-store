...
.. In `metadata`, change the `name` string to the name of your cluster. This must be the same cluster name used when you <<Edit and apply the Astra Data Store License,applied the license>>.
