...
For the Astra Data Store preview, you'll need to install Trident 2.10.1. You can install Trident using one of the following options:

* https://github.com/NetAppDocs/trident/blob/main/trident-get-started/kubernetes-deploy-tridentctl.adoc[Install Trident using tridentctl].
* https://github.com/NetAppDocs/trident/blob/main/trident-get-started/kubernetes-deploy-operator.adoc[Install Trident using Trident operator].
+
