...
summary: After you have installed Astra Data Store and addressed some environmental prerequisites, you'll also install or update Astra Trident, K8s snapshot files, the storage backend, and default storage class.
---
...
After you have installed Astra Data Store and addressed some environmental prerequisites, you'll also install or update Astra Trident, K8s snapshot files, the storage backend, and default storage class:
