...
+
----
[root@example trident]# wget <https://github.com/NetApp/trident/releases/download/v21.10.0/trident-installer-21.10.0.tar.gz>
...
+
----
[root@example trident]# gunzip trident-installer-21.10.0.tar.gz
