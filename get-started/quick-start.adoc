...
Try it out! If you want to try Astra Data Store, you can use a 90-day evaluation license. See link:../get-started/setup_ads.html#edit-and-apply-the-astra-data-store-license[licensing information] for details.
...
[role="quick-margin-para"]
link:../get-started/setup_ads.html[Learn more about the initial setup process].
...
* Configure monitoring endpoints link:../use/configure-endpoints.html[Learn more about configuring endpoints].
