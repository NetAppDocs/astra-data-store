...
== Licensing
Astra Data Store requires an Astra Data Store core license for full functionality, which licenses Astra Data Store usage by CPU core count. Astra Data Store supports 1TiB of cluster capacity for each licensed CPU core.
