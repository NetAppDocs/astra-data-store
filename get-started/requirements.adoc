...
NOTE: Astra Data Store preview requires Astra Trident version 21.10.1 or 22.01 for storage provisioning and orchestration. See the link:setup-ads.html#install-astra-trident[Astra Trident installation instructions].
