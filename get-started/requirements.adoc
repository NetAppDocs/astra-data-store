...
== Licensing
Astra Data Store requires an Astra Data Store license for full functionality. https://www.netapp.com/cloud-services/astra/data-store-form/[Sign up here^] to obtain an Astra Data Store license. Instructions to download the license will be sent to you after you sign up.
