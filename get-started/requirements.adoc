...
The minimum resource requirements for each node in an Astra Data Store cluster are as follows:
...
* Minimum number of cache devices: 1
...
* Maximum provisioned capacity per node: 1TiB (for Astra Data Store Preview edition)
