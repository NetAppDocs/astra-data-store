...
|Number of cache devices (optional to specify; see note)
...
== Licensing
Astra Data Store preview requires an Astra Data Store preview license for full functionality. Obtain a preview license from the https://mysupport.netapp.com/site/downloads/evaluation/astra-data-store[NetApp Support Site^].
