...
Get started by verifying that your environment meets Astra Data Store preview edition requirements.

//POLARIS-458
== Minimum resource requirements for each node
These are the minimum resource requirements for each node in an Astra Data Store preview edition cluster:
...
Each Astra Data Store preview edition cluster needs at least the following:
...
Each node in an Astra Data Store preview edition cluster has the following capabilities:
...
Astra Data Store preview edition has the following cluster capabilities:
...
Astra Data Store has been validated on the following hardware and software platforms.
...
== Licensing
Astra Data Store requires an Astra Data Store license for full functionality. Obtain a Preview license from the NetApp Support Site.
