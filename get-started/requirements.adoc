...
Astra Data Store preview needs a certain network interface and IP address configuration for the management, cluster, and data networks. You can use several configurations, depending on the need for one or two network interfaces per node.
