...
Each Astra Data Store preview cluster supports using persistent volumes to address the storage needs of any apps installed on that cluster. Consider the following requirements and capabilities for persistent volumes in Astra Data Store preview:
